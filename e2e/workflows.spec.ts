...
test("owner onboarding, live modules, journal posting and ledger reports",async({page})=>{
 ...
 for(const moduleName of ["Transactions","Invoices","Loads & routes","Fleet","Fuel & mileage","Maintenance","Payroll","Accounting","Reports","Approvals","Team & roles","Audit log","Settings"]){
