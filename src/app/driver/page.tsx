...
async function saveSubmission(submission:DriverSubmission){
  ...
  }catch(cause){setMessage(cause instanceof Error?cause.message:"Unable to save this submission. Keep this page open.")}
