...
export function ModuleView({module,openForm=false,assistantEnabled=false,userId,companyId}:{module:string;openForm?:boolean;assistantEnabled?:boolean;userId?:string;companyId?:string}) {
