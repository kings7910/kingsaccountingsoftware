...
export const reports: ReportDefinition[] = [
  ...
  { id:"ap-aging", name:"A/P aging", description:"Unpaid vendor balances by age with account 2000 reconciliation.", rows:[{label:"Current",current:19140,previous:20820},{label:"1–30 days",current:6280,previous:7140},{label:"31–60 days",current:2410,previous:2260},{label:"61+ days",current:920,previous:1000},{label:"A/P subledger total",current:28750,previous:31220,emphasis:"subtotal"},{label:"Ledger control · account 2000",current:28750,previous:31220},{label:"Reconciliation difference",current:0,previous:0,emphasis:"total"}]},
